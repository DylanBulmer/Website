...
// Set Up Subdomains
app.use(subdomain({ base: process.env.URL, removeWWW: true }));
...
app.get('/blog', function (req, res) {
    res.redirect('http://blog.' + process.env.url);
});

app.get('/account', function (req, res) {
    res.redirect('http://account.' + process.env.url);
});

app.get('/gaming', function (req, res) {
    res.redirect('http://gaming.' + process.env.url);
});

app.get('/store', function (req, res) {
    res.redirect('http://store.' + process.env.url);
});

app.get('/mapgame', function (req, res) {
    res.redirect('http://mapgame.' + process.env.url);
});
